...
//! `EscalateRequest` over the inherited `NEXAL_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `NEXAL_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use nexal_protocol::approvals::EscalationPermissions;
pub use nexal_protocol::approvals::Permissions;
