    ...
    fn feedback_attachments(
        ...
        if include_logs {
            attachments.push(Attachment {
                ...
                filename: String::from("nexal-logs.log"),
...
mod tests {
    ...
    fn feedback_attachments_gate_connectivity_diagnostics() {
        ...
        let attachments_without_diagnostics = NexalFeedback::new()
            .snapshot(None)
