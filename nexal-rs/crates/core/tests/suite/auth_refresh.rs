...
use nexal_core::error::RefreshTokenFailedReason;
use nexal_core::token_data::IdTokenInfo;
...
impl RefreshTokenTestContext {
    ...
    fn load_auth(&self) -> Result<AuthDotJson> {
        load_auth_dot_json(self.nexal_home.path(), AuthCredentialsStoreMode::File)
