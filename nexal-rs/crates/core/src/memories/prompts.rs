...
use nexal_rollout_state::Phase2InputSelection;
use nexal_rollout_state::Stage1Output;
use nexal_rollout_state::Stage1OutputRef;
...
pub(crate) async fn build_memory_tool_developer_instructions(nexal_home: &Path) -> Option<String> {
    let base_path = memory_root(nexal_home);
