...
use nexal_protocol::models::SearchToolCallParams;
use nexal_protocol::models::ShellToolCallParams;
use nexal_protocol::models::function_call_output_content_items_to_text;
use nexal_utils_output_truncation::TruncationPolicy;
use nexal_utils_output_truncation::formatted_truncate_text;
use nexal_utils_string::take_bytes_at_char_boundary;
use serde::Serialize;
        ...
        ResponseInputItem::Message { content, .. } => content_items_to_code_mode_result(
            &content
                ...
                .map(|item| match item {
                    ...
                    nexal_protocol::models::ContentItem::InputImage { image_url } => {
