pub(crate) const OTEL_TARGET_PREFIX: &str = "nexal_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "nexal_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "nexal_otel.trace_safe";
