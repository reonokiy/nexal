...
pub use nexal_utils_string::sanitize_metric_tag_value;
...
impl From<nexal_app_server_protocol::AuthMode> for TelemetryAuthMode {
    fn from(mode: nexal_app_server_protocol::AuthMode) -> Self {
        match mode {
            nexal_app_server_protocol::AuthMode::ApiKey => Self::ApiKey,
            nexal_app_server_protocol::AuthMode::Chatgpt
            | nexal_app_server_protocol::AuthMode::ChatgptAuthTokens => Self::Chatgpt,
        }
    }
}
