...
use nexal_core::auth::load_auth_dot_json;
...
pub(crate) fn load_local_chatgpt_auth(
    ...
    let auth = load_auth_dot_json(nexal_home, auth_credentials_store_mode)
...
mod tests {
    ...
    fn write_chatgpt_auth(nexal_home: &Path) {
        ...
        let auth = AuthDotJson {
            ...
            tokens: Some(TokenData {
                id_token: nexal_core::token_data::parse_chatgpt_jwt_claims(&id_token)
        ...
        save_auth(nexal_home, &auth, AuthCredentialsStoreMode::File)
    ...
    fn loads_local_chatgpt_auth_from_managed_auth() {
        ...
        write_chatgpt_auth(nexal_home.path());
