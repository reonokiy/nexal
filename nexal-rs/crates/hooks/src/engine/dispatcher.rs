...
use nexal_protocol::protocol::HookExecutionMode;
use nexal_protocol::protocol::HookHandlerType;
use nexal_protocol::protocol::HookRunStatus;
use nexal_protocol::protocol::HookRunSummary;
use nexal_protocol::protocol::HookScope;
...
pub(crate) fn completed_summary(
    ...
    entries: Vec<nexal_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
