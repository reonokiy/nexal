...
use nexal_experimental_api_macros::ExperimentalApi;
use nexal_protocol::account::PlanType;
use nexal_protocol::approvals::ElicitationRequest as CoreElicitationRequest;
use nexal_protocol::approvals::ExecApprovalRequestSkillMetadata as CoreExecApprovalRequestSkillMetadata;
use nexal_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use nexal_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use nexal_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use nexal_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use nexal_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use nexal_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use nexal_protocol::config_types::CollaborationMode;
use nexal_protocol::config_types::CollaborationModeMask as CoreCollaborationModeMask;
...
use nexal_protocol::items::AgentMessageContent as CoreAgentMessageContent;
use nexal_protocol::items::TurnItem as CoreTurnItem;
use nexal_protocol::mcp::Resource as McpResource;
use nexal_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use nexal_protocol::mcp::Tool as McpTool;
...
use nexal_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use nexal_protocol::openai_models::ReasoningEffort;
use nexal_protocol::openai_models::default_input_modalities;
use nexal_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use nexal_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use nexal_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use nexal_protocol::protocol::AgentStatus as CoreAgentStatus;
...
use nexal_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use nexal_protocol::protocol::ExecCommandSource as CoreExecCommandSource;
use nexal_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use nexal_protocol::protocol::GranularApprovalConfig as CoreGranularApprovalConfig;
use nexal_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use nexal_protocol::protocol::HookEventName as CoreHookEventName;
use nexal_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use nexal_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use nexal_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use nexal_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use nexal_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use nexal_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use nexal_protocol::protocol::HookScope as CoreHookScope;
use nexal_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use nexal_protocol::protocol::NetworkAccess as CoreNetworkAccess;
use nexal_protocol::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
...
use nexal_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use nexal_protocol::protocol::ReadOnlyAccess as CoreReadOnlyAccess;
use nexal_protocol::protocol::RealtimeAudioFrame as CoreRealtimeAudioFrame;
use nexal_protocol::protocol::RealtimeConversationVersion;
use nexal_protocol::protocol::ReviewDecision as CoreReviewDecision;
use nexal_protocol::protocol::SessionSource as CoreSessionSource;
use nexal_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use nexal_protocol::protocol::SkillErrorInfo as CoreSkillErrorInfo;
use nexal_protocol::protocol::SkillInterface as CoreSkillInterface;
use nexal_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use nexal_protocol::protocol::SkillScope as CoreSkillScope;
use nexal_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
use nexal_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use nexal_protocol::protocol::TokenUsage as CoreTokenUsage;
use nexal_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
use nexal_protocol::user_input::ByteRange as CoreByteRange;
use nexal_protocol::user_input::TextElement as CoreTextElement;
use nexal_protocol::user_input::UserInput as CoreUserInput;
...
/// This translation layer make sure that we expose nexal error code in camel case.
///
...
impl From<CoreNexalErrorInfo> for NexalErrorInfo {
    fn from(value: CoreNexalErrorInfo) -> Self {
        match value {
            CoreNexalErrorInfo::ContextWindowExceeded => NexalErrorInfo::ContextWindowExceeded,
            CoreNexalErrorInfo::UsageLimitExceeded => NexalErrorInfo::UsageLimitExceeded,
            CoreNexalErrorInfo::ServerOverloaded => NexalErrorInfo::ServerOverloaded,
            CoreNexalErrorInfo::HttpConnectionFailed { http_status_code } => {
                NexalErrorInfo::HttpConnectionFailed { http_status_code }
            }
            CoreNexalErrorInfo::ResponseStreamConnectionFailed { http_status_code } => {
                NexalErrorInfo::ResponseStreamConnectionFailed { http_status_code }
            }
            CoreNexalErrorInfo::InternalServerError => NexalErrorInfo::InternalServerError,
            CoreNexalErrorInfo::Unauthorized => NexalErrorInfo::Unauthorized,
            CoreNexalErrorInfo::BadRequest => NexalErrorInfo::BadRequest,
            CoreNexalErrorInfo::ThreadRollbackFailed => NexalErrorInfo::ThreadRollbackFailed,
            CoreNexalErrorInfo::SandboxError => NexalErrorInfo::SandboxError,
            CoreNexalErrorInfo::ResponseStreamDisconnected { http_status_code } => {
                NexalErrorInfo::ResponseStreamDisconnected { http_status_code }
            }
            CoreNexalErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                NexalErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CoreNexalErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                NexalErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CoreNexalErrorInfo::Other => NexalErrorInfo::Other,
        }
    }
}
...
v2_enum_from_core!(
    pub enum ReviewDelivery from nexal_protocol::protocol::ReviewDelivery {
        Inline, Detached
    }
);

v2_enum_from_core!(
    pub enum McpAuthStatus from nexal_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
pub enum ConfigLayerSource {
    ...
    /// User config layer from $NEXAL_HOME/config.toml. This layer is special
    ...
    /// Path to a .nexal/ folder within a project. There could be multiple of
    /// these between `cwd` and the project/repo root.
    #[serde(rename_all = "camelCase")]
    #[ts(rename_all = "camelCase")]
    Project {
        dot_nexal_folder: AbsolutePathBuf,
    },
...
pub struct ExternalAgentConfigDetectParams {
    /// If true, include detection under the user's home (~/.claude, ~/.nexal, etc.).
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
...
impl SandboxPolicy {
    pub fn to_core(&self) -> nexal_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<nexal_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: nexal_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            nexal_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            ...
            nexal_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Nexal-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Nexal attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Nexal attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Nexal was previously using.
    ///
...
pub struct GetAccountRateLimitsResponse {
    ...
    /// Multi-bucket view keyed by metered `limit_id` (for example, `nexal`).
...
pub struct ThreadStartParams {
    ...
    /// This is for internal use only (e.g. Nexal Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR NEXAL CLOUD - DO NOT USE.
...
pub struct Thread {
    ...
    /// Origin of the thread (CLI, VSCode, nexal exec, nexal app-server, etc.).
...
pub struct TurnError {
    pub message: String,
    pub nexal_error_info: Option<NexalErrorInfo>,
    #[serde(default)]
...
impl From<nexal_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: nexal_protocol::models::WebSearchAction) -> Self {
        match value {
            ...
            nexal_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<nexal_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: nexal_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> nexal_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => nexal_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => nexal_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => nexal_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Nexal turn when this elicitation was observed, if app-server could correlate one.
    ///
...
impl From<DynamicToolCallOutputContentItem>
    for nexal_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
...
mod tests {
    ...
    use nexal_protocol::items::ReasoningItem;
    use nexal_protocol::items::TurnItem;
    use nexal_protocol::items::UserMessageItem;
    use nexal_protocol::items::WebSearchItem;
    use nexal_protocol::models::WebSearchAction as CoreWebSearchAction;
    use nexal_protocol::protocol::NetworkAccess as CoreNetworkAccess;
    use nexal_protocol::protocol::ReadOnlyAccess as CoreReadOnlyAccess;
    use nexal_protocol::user_input::UserInput as CoreUserInput;
        ...
        let user_item = TurnItem::UserMessage(UserMessageItem {
            ...
            content: vec![
                ...
                CoreUserInput::Skill {
                    ...
                    path: PathBuf::from("/repo/.nexal/skills/skill-creator/SKILL.md"),
                },
    ...
    #[test]
    fn nexal_error_info_serializes_http_status_code_in_camel_case() {
        let value = NexalErrorInfo::ResponseTooManyFailedAttempts {
    ...
    #[test]
    fn nexal_error_info_serializes_active_turn_not_steerable_turn_kind_in_camel_case() {
        let value = NexalErrorInfo::ActiveTurnNotSteerable {
