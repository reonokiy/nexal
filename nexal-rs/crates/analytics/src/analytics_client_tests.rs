...
use super::NexalAppMentionedEventRequest;
use super::NexalAppUsedEventRequest;
use super::NexalPluginEventRequest;
use super::NexalPluginUsedEventRequest;
use super::InvocationType;
use super::TrackEventRequest;
use super::TrackEventsContext;
use super::nexal_app_metadata;
use super::nexal_plugin_metadata;
use super::nexal_plugin_used_metadata;
...
fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
    ...
    let skill_path = PathBuf::from("/repo/root/.nexal/skills/doc/SKILL.md");
    ...
    assert_eq!(path, ".nexal/skills/doc/SKILL.md");
}

#[test]
fn normalize_path_for_skill_id_user_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/Users/abc/.nexal/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
    let repo_root = PathBuf::from("/repo/root");
    let skill_path = PathBuf::from("/other/path/.nexal/skills/doc/SKILL.md");
...
fn app_mentioned_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppMentioned(NexalAppMentionedEventRequest {
        event_type: "nexal_app_mentioned",
        event_params: nexal_app_metadata(
            &tracking,
            AppInvocation {
...
fn app_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppUsed(NexalAppUsedEventRequest {
...
fn plugin_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::PluginUsed(NexalPluginUsedEventRequest {
        event_type: "nexal_plugin_used",
        event_params: nexal_plugin_used_metadata(&tracking, sample_plugin_metadata()),
    });
...
fn plugin_management_event_serializes_expected_shape() {
    let event = TrackEventRequest::PluginInstalled(NexalPluginEventRequest {
        event_type: "nexal_plugin_installed",
        event_params: nexal_plugin_metadata(sample_plugin_metadata()),
    });
