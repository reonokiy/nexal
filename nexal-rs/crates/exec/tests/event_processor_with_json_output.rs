...
use nexal_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use nexal_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use nexal_app_server_protocol::CollabAgentTool;
use nexal_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use nexal_app_server_protocol::CommandAction;
use nexal_app_server_protocol::CommandExecutionSource;
use nexal_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use nexal_app_server_protocol::ErrorNotification;
use nexal_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
...
use nexal_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use nexal_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use nexal_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use nexal_app_server_protocol::WebSearchAction as ApiWebSearchAction;
...
use nexal_exec::event_processor_with_jsonl_output::NexalStatus;
use nexal_exec::event_processor_with_jsonl_output::CollectedThreadEvents;
use nexal_exec::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use nexal_exec::exec_events::AgentMessageItem;
use nexal_exec::exec_events::CollabAgentState;
use nexal_exec::exec_events::CollabAgentStatus;
use nexal_exec::exec_events::CollabTool;
use nexal_exec::exec_events::CollabToolCallItem;
use nexal_exec::exec_events::CollabToolCallStatus;
use nexal_exec::exec_events::CommandExecutionItem;
use nexal_exec::exec_events::CommandExecutionStatus;
use nexal_exec::exec_events::ErrorItem;
use nexal_exec::exec_events::FileChangeItem;
use nexal_exec::exec_events::FileUpdateChange as ExecFileUpdateChange;
use nexal_exec::exec_events::ItemCompletedEvent;
use nexal_exec::exec_events::ItemStartedEvent;
use nexal_exec::exec_events::ItemUpdatedEvent;
use nexal_exec::exec_events::McpToolCallItem;
use nexal_exec::exec_events::McpToolCallItemError;
use nexal_exec::exec_events::McpToolCallItemResult;
use nexal_exec::exec_events::McpToolCallStatus;
use nexal_exec::exec_events::PatchApplyStatus;
use nexal_exec::exec_events::PatchChangeKind;
use nexal_exec::exec_events::ReasoningItem;
use nexal_exec::exec_events::ThreadErrorEvent;
use nexal_exec::exec_events::ThreadEvent;
use nexal_exec::exec_events::ThreadItem as ExecThreadItem;
use nexal_exec::exec_events::ThreadItemDetails;
use nexal_exec::exec_events::ThreadStartedEvent;
use nexal_exec::exec_events::TodoItem;
use nexal_exec::exec_events::TodoListItem;
use nexal_exec::exec_events::TurnCompletedEvent;
use nexal_exec::exec_events::TurnFailedEvent;
use nexal_exec::exec_events::TurnStartedEvent;
use nexal_exec::exec_events::Usage;
use nexal_exec::exec_events::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    let session_configured = SessionConfiguredEvent {
        ...
        forked_from_id: None,
        thread_name: None,
        model: "nexal-mini-latest".to_string(),
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: NexalStatus::InitiateShutdown,
        }
    );
}
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            nexal_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, NexalStatus::Running);
    ...
    assert_eq!(collected.status, NexalStatus::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        nexal_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: nexal_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
