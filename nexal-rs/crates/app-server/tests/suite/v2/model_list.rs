...
use nexal_app_server_protocol::Model;
use nexal_app_server_protocol::ModelListParams;
use nexal_app_server_protocol::ModelListResponse;
use nexal_app_server_protocol::ModelUpgradeInfo;
use nexal_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets =
        ModelPreset::filter_by_auth(nexal_core::test_support::all_model_presets().clone(), false);
