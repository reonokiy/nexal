...
const QUALIFIED_TOOL_NAME: &str = "mcp__nexal_apps__calendar_confirm_action";
...
async fn mcp_server_elicitation_round_trip() -> Result<()> {
    ...
    write_config_toml(nexal_home.path(), &responses_server.uri(), &apps_server_url)?;
    write_chatgpt_auth(
        nexal_home.path(),
    ...
    assert_eq!(
        ...
        McpServerElicitationRequestParams {
            ...
            server_name: "nexal_apps".to_string(),
