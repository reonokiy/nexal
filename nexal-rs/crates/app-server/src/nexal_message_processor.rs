...
use chrono::Utc;
use nexal_app_server_protocol::Account;
use nexal_app_server_protocol::AccountLoginCompletedNotification;
use nexal_app_server_protocol::AccountUpdatedNotification;
use nexal_app_server_protocol::AppInfo;
use nexal_app_server_protocol::AppsListParams;
use nexal_app_server_protocol::AppsListResponse;
use nexal_app_server_protocol::AskForApproval;
use nexal_app_server_protocol::AuthMode;
use nexal_app_server_protocol::CancelLoginAccountParams;
use nexal_app_server_protocol::CancelLoginAccountResponse;
use nexal_app_server_protocol::CancelLoginAccountStatus;
...
use nexal_app_server_protocol::CommandExecParams;
use nexal_app_server_protocol::CommandExecResizeParams;
use nexal_app_server_protocol::CommandExecTerminateParams;
use nexal_app_server_protocol::CommandExecWriteParams;
use nexal_app_server_protocol::ConversationGitInfo;
use nexal_app_server_protocol::ConversationSummary;
use nexal_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use nexal_app_server_protocol::ExperimentalFeature as ApiExperimentalFeature;
...
use nexal_app_server_protocol::FuzzyFileSearchSessionStartResponse;
use nexal_app_server_protocol::FuzzyFileSearchSessionStopParams;
use nexal_app_server_protocol::FuzzyFileSearchSessionStopResponse;
use nexal_app_server_protocol::FuzzyFileSearchSessionUpdateParams;
use nexal_app_server_protocol::FuzzyFileSearchSessionUpdateResponse;
...
use nexal_app_server_protocol::GetAuthStatusParams;
use nexal_app_server_protocol::GetAuthStatusResponse;
use nexal_app_server_protocol::GetConversationSummaryParams;
use nexal_app_server_protocol::GetConversationSummaryResponse;
use nexal_app_server_protocol::GitDiffToRemoteResponse;
use nexal_app_server_protocol::GitInfo as ApiGitInfo;
...
use nexal_app_server_protocol::McpServerOauthLoginCompletedNotification;
use nexal_app_server_protocol::McpServerOauthLoginParams;
use nexal_app_server_protocol::McpServerOauthLoginResponse;
use nexal_app_server_protocol::McpServerRefreshResponse;
use nexal_app_server_protocol::McpServerStatus;
use nexal_app_server_protocol::MockExperimentalMethodParams;
use nexal_app_server_protocol::MockExperimentalMethodResponse;
use nexal_app_server_protocol::ModelListParams;
use nexal_app_server_protocol::ModelListResponse;
use nexal_app_server_protocol::PluginDetail;
use nexal_app_server_protocol::PluginInstallParams;
use nexal_app_server_protocol::PluginInstallResponse;
use nexal_app_server_protocol::PluginInterface;
use nexal_app_server_protocol::PluginListParams;
use nexal_app_server_protocol::PluginListResponse;
use nexal_app_server_protocol::PluginMarketplaceEntry;
use nexal_app_server_protocol::PluginReadParams;
use nexal_app_server_protocol::PluginReadResponse;
use nexal_app_server_protocol::PluginSource;
use nexal_app_server_protocol::PluginSummary;
use nexal_app_server_protocol::PluginUninstallParams;
use nexal_app_server_protocol::PluginUninstallResponse;
use nexal_app_server_protocol::RequestId;
use nexal_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use nexal_app_server_protocol::ReviewStartParams;
use nexal_app_server_protocol::ReviewStartResponse;
use nexal_app_server_protocol::ReviewTarget as ApiReviewTarget;
use nexal_app_server_protocol::SandboxMode;
use nexal_app_server_protocol::ServerNotification;
use nexal_app_server_protocol::ServerRequestResolvedNotification;
use nexal_app_server_protocol::SkillSummary;
use nexal_app_server_protocol::SkillsConfigWriteParams;
use nexal_app_server_protocol::SkillsConfigWriteResponse;
use nexal_app_server_protocol::SkillsListParams;
use nexal_app_server_protocol::SkillsListResponse;
use nexal_app_server_protocol::Thread;
use nexal_app_server_protocol::ThreadArchiveParams;
use nexal_app_server_protocol::ThreadArchiveResponse;
use nexal_app_server_protocol::ThreadArchivedNotification;
use nexal_app_server_protocol::ThreadBackgroundTerminalsCleanParams;
use nexal_app_server_protocol::ThreadBackgroundTerminalsCleanResponse;
use nexal_app_server_protocol::ThreadClosedNotification;
use nexal_app_server_protocol::ThreadCompactStartParams;
use nexal_app_server_protocol::ThreadCompactStartResponse;
use nexal_app_server_protocol::ThreadDecrementElicitationParams;
use nexal_app_server_protocol::ThreadDecrementElicitationResponse;
use nexal_app_server_protocol::ThreadForkParams;
use nexal_app_server_protocol::ThreadForkResponse;
use nexal_app_server_protocol::ThreadIncrementElicitationParams;
use nexal_app_server_protocol::ThreadIncrementElicitationResponse;
use nexal_app_server_protocol::ThreadItem;
use nexal_app_server_protocol::ThreadListParams;
use nexal_app_server_protocol::ThreadListResponse;
use nexal_app_server_protocol::ThreadLoadedListParams;
use nexal_app_server_protocol::ThreadLoadedListResponse;
use nexal_app_server_protocol::ThreadMetadataGitInfoUpdateParams;
use nexal_app_server_protocol::ThreadMetadataUpdateParams;
use nexal_app_server_protocol::ThreadMetadataUpdateResponse;
use nexal_app_server_protocol::ThreadNameUpdatedNotification;
use nexal_app_server_protocol::ThreadReadParams;
use nexal_app_server_protocol::ThreadReadResponse;
use nexal_app_server_protocol::ThreadRealtimeAppendAudioParams;
use nexal_app_server_protocol::ThreadRealtimeAppendAudioResponse;
use nexal_app_server_protocol::ThreadRealtimeAppendTextParams;
use nexal_app_server_protocol::ThreadRealtimeAppendTextResponse;
use nexal_app_server_protocol::ThreadRealtimeStartParams;
use nexal_app_server_protocol::ThreadRealtimeStartResponse;
use nexal_app_server_protocol::ThreadRealtimeStopParams;
use nexal_app_server_protocol::ThreadRealtimeStopResponse;
use nexal_app_server_protocol::ThreadResumeParams;
use nexal_app_server_protocol::ThreadResumeResponse;
use nexal_app_server_protocol::ThreadRollbackParams;
use nexal_app_server_protocol::ThreadSetNameParams;
use nexal_app_server_protocol::ThreadSetNameResponse;
use nexal_app_server_protocol::ThreadShellCommandParams;
use nexal_app_server_protocol::ThreadShellCommandResponse;
use nexal_app_server_protocol::ThreadSortKey;
...
use nexal_app_server_protocol::ThreadStartedNotification;
use nexal_app_server_protocol::ThreadStatus;
use nexal_app_server_protocol::ThreadUnarchiveParams;
use nexal_app_server_protocol::ThreadUnarchiveResponse;
use nexal_app_server_protocol::ThreadUnarchivedNotification;
use nexal_app_server_protocol::ThreadUnsubscribeParams;
use nexal_app_server_protocol::ThreadUnsubscribeResponse;
use nexal_app_server_protocol::ThreadUnsubscribeStatus;
use nexal_app_server_protocol::Turn;
use nexal_app_server_protocol::TurnError;
...
use nexal_core::Cursor as RolloutCursor;
use nexal_core::ForkSnapshot;
use nexal_core::NewThread;
use nexal_core::RolloutRecorder;
use nexal_core::SessionMeta;
use nexal_core::SteerInputError;
...
use nexal_core::config::NetworkProxyAuditMetadata;
use nexal_core::config::edit::ConfigEdit;
use nexal_core::config::edit::ConfigEditsBuilder;
use nexal_core::config::types::McpServerTransportConfig;
use nexal_core::config_loader::CloudRequirementsLoadError;
use nexal_core::config_loader::CloudRequirementsLoadErrorCode;
...
use nexal_core::exec::ExecExpiration;
use nexal_core::exec::ExecParams;
use nexal_core::exec_env::create_env;
use nexal_core::find_archived_thread_path_by_id_str;
use nexal_core::find_thread_name_by_id;
use nexal_core::find_thread_names_by_ids;
use nexal_core::find_thread_path_by_id_str;
use nexal_core::mcp::auth::discover_supported_scopes;
use nexal_core::mcp::auth::resolve_oauth_scopes;
use nexal_core::mcp::collect_mcp_snapshot;
use nexal_core::mcp::group_tools_by_server;
use nexal_core::models_manager::collaboration_mode_presets::CollaborationModesConfig;
use nexal_core::parse_cursor;
use nexal_core::plugins::MarketplaceError;
use nexal_core::plugins::MarketplacePluginSource;
use nexal_core::plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use nexal_core::plugins::PluginInstallError as CorePluginInstallError;
use nexal_core::plugins::PluginInstallRequest;
use nexal_core::plugins::PluginReadRequest;
use nexal_core::plugins::PluginUninstallError as CorePluginUninstallError;
use nexal_core::plugins::load_plugin_apps;
use nexal_core::plugins::load_plugin_mcp_servers;
use nexal_core::read_head_for_summary;
use nexal_core::read_session_meta_line;
use nexal_core::rollout_date_parts;
...
use nexal_protocol::protocol::ConversationStartParams;
use nexal_protocol::protocol::ConversationTextParams;
use nexal_protocol::protocol::EventMsg;
use nexal_protocol::protocol::GitInfo as CoreGitInfo;
use nexal_protocol::protocol::InitialHistory;
use nexal_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
use nexal_protocol::protocol::McpServerRefreshConfig;
use nexal_protocol::protocol::Op;
use nexal_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use nexal_protocol::protocol::ReviewDelivery as CoreReviewDelivery;
use nexal_protocol::protocol::ReviewRequest;
use nexal_protocol::protocol::ReviewTarget as CoreReviewTarget;
...
use nexal_protocol::protocol::USER_MESSAGE_BEGIN;
use nexal_protocol::protocol::W3cTraceContext;
use nexal_protocol::user_input::MAX_USER_INPUT_TEXT_CHARS;
use nexal_protocol::user_input::UserInput as CoreInputItem;
use nexal_rmcp_client::perform_oauth_login_return_url;
use nexal_rollout_state::StateRuntime;
use nexal_rollout_state::ThreadMetadata;
...
use nexal_utils_pty::DEFAULT_OUTPUT_BYTES_CAP;
...
impl NexalMessageProcessor {
    ...
    async fn load_thread(
        &self,
        thread_id: &str,
    ) -> Result<(ThreadId, Arc<NexalThread>), JSONRPCErrorError> {
    ...
    pub fn new(args: NexalMessageProcessorArgs) -> Self {
        let NexalMessageProcessorArgs {
            auth_manager,
            thread_manager,
            outgoing,
            arg0_paths,
    ...
    async fn load_latest_config(
        ...
        let mut config = nexal_core::config::ConfigBuilder::default()
        ...
        config.nexal_self_exe = self.arg0_paths.nexal_self_exe.clone();
        config.nexal_linux_sandbox_exe = self.arg0_paths.nexal_linux_sandbox_exe.clone();
    ...
    fn review_request_from_target(
        ...
        let hint = nexal_core::review_prompts::user_facing_hint(&core_target);
    ...
    pub async fn process_request(
        ...
        match request {
            ...
            | ClientRequest::ExperimentalFeatureEnablementSet { .. } => {
                warn!("Config request reached NexalMessageProcessor unexpectedly");
            }
            ...
            | ClientRequest::FsUnwatch { .. } => {
                warn!("Filesystem request reached NexalMessageProcessor unexpectedly");
            }
            ClientRequest::ConfigRequirementsRead { .. } => {
                warn!("ConfigRequirementsRead request reached NexalMessageProcessor unexpectedly");
            }
            ClientRequest::ExternalAgentConfigDetect { .. }
            | ClientRequest::ExternalAgentConfigImport { .. } => {
                warn!("ExternalAgentConfig request reached NexalMessageProcessor unexpectedly");
            }
    ...
    async fn login_api_key_v2(
        ...
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = nexal_app_server_protocol::LoginAccountResponse::ApiKey {};
    ...
    async fn exec_one_off_command(
            ...
            Some(policy) => match self.config.permissions.sandbox_policy.can_set(&policy) {
                Ok(()) => {
                    let file_system_sandbox_policy =
                        nexal_protocol::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy(&policy, &sandbox_cwd);
                    let network_sandbox_policy =
                        nexal_protocol::permissions::NetworkSandboxPolicy::from(&policy);
        ...
        let nexal_linux_sandbox_exe = self.arg0_paths.nexal_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        ...
        match nexal_core::exec::build_exec_request(
            exec_params,
            &effective_policy,
            &effective_file_system_sandbox_policy,
            effective_network_sandbox_policy,
    ...
    async fn thread_start(
        ...
        let listener_task_context = ListenerTaskContext {
            ...
            nexal_home: self.config.nexal_home.clone(),
        };
    ...
    async fn request_trace_context(
        &self,
        request_id: &ConnectionRequestId,
    ) -> Option<nexal_protocol::protocol::W3cTraceContext> {
    ...
    async fn thread_start_task(
        ...
        let config = match derive_config_from_params(
            ...
            typesafe_overrides,
            &cloud_requirements,
            &listener_task_context.nexal_home,
            &runtime_feature_enablement,
        )
        .await
        {
    ...
    fn build_thread_config_overrides(
        ...
        service_tier: Option<Option<nexal_protocol::config_types::ServiceTier>>,
        cwd: Option<String>,
        approval_policy: Option<nexal_app_server_protocol::AskForApproval>,
        approvals_reviewer: Option<nexal_app_server_protocol::ApprovalsReviewer>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(nexal_app_server_protocol::AskForApproval::to_core),
            approvals_reviewer: approvals_reviewer
                .map(nexal_app_server_protocol::ApprovalsReviewer::to_core),
            sandbox_mode: sandbox.map(SandboxMode::to_core),
            nexal_linux_sandbox_exe: self.arg0_paths.nexal_linux_sandbox_exe.clone(),
    ...
    async fn thread_archive(
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.nexal_home, &thread_id.to_string()).await
            {
                Ok(Some(p)) => p,
                Ok(None) => {
                    let error = JSONRPCErrorError {
    ...
    async fn thread_decrement_elicitation(
        ...
        match thread.decrement_out_of_band_elicitation_count().await {
            ...
            Err(NexalErr::InvalidRequest(message)) => {
    ...
    async fn thread_set_name(&self, request_id: ConnectionRequestId, params: ThreadSetNameParams) {
        ...
        if let Err(err) =
            nexal_core::append_thread_name(&self.config.nexal_home, thread_id, &name).await
        {
            self.send_internal_error(request_id, format!("failed to set thread name: {err}"))
                .await;
            return;
    ...
    async fn ensure_thread_metadata_row_exists(
        ...
        loaded_thread: Option<&Arc<NexalThread>>,
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.nexal_home, &thread_uuid.to_string())
                .await
            {
                Ok(Some(path)) => path,
    ...
    async fn thread_unarchive(
        ...
        let archived_folder = self
            .config
            .nexal_home
            .join(nexal_core::ARCHIVED_SESSIONS_SUBDIR);
        ...
        let result: Result<Thread, JSONRPCErrorError> = async {
            ...
            let sessions_folder = self.config.nexal_home.join(nexal_core::SESSIONS_SUBDIR);
    ...
    async fn thread_list(&self, request_id: ConnectionRequestId, params: ThreadListParams) {
        ...
        let names = match find_thread_names_by_ids(&self.config.nexal_home, &thread_ids).await {
            Ok(names) => names,
            Err(err) => {
    ...
    async fn attach_thread_name(&self, thread_id: ThreadId, thread: &mut Thread) {
        match find_thread_name_by_id(&self.config.nexal_home, &thread_id).await {
            Ok(name) => {
                thread.name = name;
            }
            Err(err) => {
            ...
            .await
        {
            ...
            Err(err) => {
                match err {
                    ...
                    NexalErr::InvalidRequest(message) => {
                        self.send_invalid_request_error(request_id, message).await;
                    }
                    _ => {
                        self.send_internal_error(
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.nexal_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match nexal_core::find_thread_path_by_id_str(
                    &self.config.nexal_home,
    ...
    async fn wait_for_thread_shutdown(thread: &Arc<NexalThread>) -> ThreadShutdownResult {
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.nexal_home.join(nexal_core::SESSIONS_SUBDIR);
        ...
        for cwd in cwds {
            ...
            let cwd_abs = match AbsolutePathBuf::try_from(cwd.as_path()) {
                ...
                Err(err) => {
                    ...
                    data.push(nexal_app_server_protocol::SkillsListEntry {
                        cwd,
                        skills: Vec::new(),
                        errors: errors_to_info(&[nexal_core::skills::SkillError {
                            path: error_path,
            ...
            let skills_input = nexal_core::skills::SkillsLoadInput::new(
                cwd.clone(),
        ...
        let (data, marketplace_load_errors) = match tokio::task::spawn_blocking(move || {
            ...
            Ok::<
                (
                    ...
                    Vec<nexal_app_server_protocol::MarketplaceLoadErrorInfo>,
                ),
                MarketplaceError,
            >((
                outcome
                ...
                outcome
                    .errors
                    .into_iter()
                    .map(|err| nexal_app_server_protocol::MarketplaceLoadErrorInfo {
    ...
    async fn skills_config_write(
        ...
        let edits = vec![edit];
        let result = ConfigEditsBuilder::new(&self.config.nexal_home)
            .with_edits(edits)
            .apply()
            .await;
        ...
        match install_result {
            Ok(result) => {
                    ...
                    || !config.features.apps_enabled(Some(&self.auth_manager)).await
                {
                    ...
                    let (accessible_connectors, nexal_apps_ready) =
                        match accessible_connectors_result {
                            Ok(status) => (status.connectors, status.nexal_apps_ready),
                            Err(err) => {
                                warn!(
                                    plugin = result.plugin_id.as_key(),
                    ...
                    if !nexal_apps_ready {
                        warn!(
                            plugin = result.plugin_id.as_key(),
                            "nexal_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
                        );
                    }
                ...
                let (code, message, data) = match err {
                    ...
                    SteerInputError::ActiveTurnNotSteerable { turn_kind } => {
                        let message = match turn_kind {
                            nexal_protocol::protocol::NonSteerableTurnKind::Review => {
                                "cannot steer a review turn".to_string()
                            }
                            nexal_protocol::protocol::NonSteerableTurnKind::Compact => {
                                "cannot steer a compact turn".to_string()
                            }
                        };
                        let error = TurnError {
                            message: message.clone(),
                            nexal_error_info: Some(
    ...
    async fn prepare_realtime_conversation_thread(
        ...
        request_id: ConnectionRequestId,
        thread_id: &str,
    ) -> Option<(ThreadId, Arc<NexalThread>)> {
        let (thread_id, thread) = match self.load_thread(thread_id).await {
            Ok(v) => v,
            Err(error) => {
                self.outgoing.send_error(request_id, error).await;
    ...
    async fn start_detached_review(
        ...
        let rollout_path = if let Some(path) = parent_thread.rollout_path() {
            ...
            find_thread_path_by_id_str(&self.config.nexal_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
...
async fn handle_pending_thread_resume_request(
    ...
    match find_thread_name_by_id(nexal_home, &conversation_id).await {
...
fn collect_resume_override_mismatches(
    ...
    if let Some(requested_review_policy) = request.approvals_reviewer.as_ref() {
        let active_review_policy: nexal_app_server_protocol::ApprovalsReviewer =
    ...
    if let Some(requested_sandbox) = request.sandbox.as_ref() {
        let sandbox_matches = matches!(
            ...
            (
                ...
                nexal_protocol::protocol::SandboxPolicy::DangerFullAccess
            ) | (
                SandboxMode::DangerFullAccess,
                nexal_protocol::protocol::SandboxPolicy::ExternalSandbox { .. }
            )
        );
        if !sandbox_matches {
            mismatch_details.push(format!(
...
fn skills_to_info(
    skills: &[nexal_core::skills::SkillMetadata],
    disabled_paths: &std::collections::HashSet<PathBuf>,
) -> Vec<nexal_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path_to_skills_md);
            nexal_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    nexal_app_server_protocol::SkillInterface {
                        display_name: interface.display_name,
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    nexal_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| nexal_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn plugin_interface_to_info(
    interface: nexal_core::plugins::PluginManifestInterface,
) -> PluginInterface {
    PluginInterface {
        display_name: interface.display_name,
        short_description: interface.short_description,
...
fn errors_to_info(
    errors: &[nexal_core::skills::SkillError],
) -> Vec<nexal_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| nexal_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
fn validate_dynamic_tools(tools: &[ApiDynamicToolSpec]) -> Result<(), String> {
    ...
    for tool in tools {
        ...
        if let Err(err) = nexal_core::parse_tool_input_schema(&tool.input_schema) {
            return Err(format!(
...
async fn summary_from_thread_list_item(
    ...
    if let Some(thread_id) = it.thread_id {
        ...
        let source = with_thread_spawn_agent_metadata(
            it.source
                .unwrap_or(nexal_protocol::protocol::SessionSource::Unknown),
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match nexal_core::parse_turn_item(&item) {
...
fn preview_from_rollout_items(items: &[RolloutItem]) -> String {
    items
        ...
        .find_map(|item| match item {
            RolloutItem::ResponseItem(item) => match nexal_core::parse_turn_item(item) {
                Some(nexal_protocol::items::TurnItem::UserMessage(user)) => Some(user.message()),
                _ => None,
            },
            _ => None,
        })
...
fn with_thread_spawn_agent_metadata(
    source: nexal_protocol::protocol::SessionSource,
    agent_nickname: Option<String>,
    agent_role: Option<String>,
) -> nexal_protocol::protocol::SessionSource {
    if agent_nickname.is_none() && agent_role.is_none() {
        return source;
    }

    match source {
        nexal_protocol::protocol::SessionSource::SubAgent(
...
mod tests {
    ...
    use nexal_protocol::protocol::SubAgentSource;
    ...
    fn collect_resume_override_mismatches_includes_service_tier() {
        let request = ThreadResumeParams {
            ...
            model: None,
            model_provider: None,
            service_tier: Some(Some(nexal_protocol::config_types::ServiceTier::Fast)),
            cwd: None,
        ...
        let config_snapshot = ThreadConfigSnapshot {
            ...
            service_tier: Some(nexal_protocol::config_types::ServiceTier::Flex),
            approval_policy: nexal_protocol::protocol::AskForApproval::OnRequest,
            approvals_reviewer: nexal_protocol::config_types::ApprovalsReviewer::User,
            sandbox_policy: nexal_protocol::protocol::SandboxPolicy::DangerFullAccess,
    ...
    fn test_thread_metadata(
        ...
        let mut builder = ThreadMetadataBuilder::new(
            ...
            Utc::now(),
            nexal_protocol::protocol::SessionSource::default(),
        );
    ...
    fn merge_persisted_resume_metadata_prefers_persisted_model_and_reasoning_effort() -> Result<()>
    {
        ...
        let persisted_metadata =
            test_thread_metadata(Some("gpt-5.1-nexal-max"), Some(ReasoningEffort::High))?;
        ...
        assert_eq!(
            ...
            Some("gpt-5.1-nexal-max".to_string())
        );
        assert_eq!(
            request_overrides,
            Some(HashMap::from([(
    ...
    fn merge_persisted_resume_metadata_preserves_explicit_overrides() -> Result<()> {
        ...
        let mut typesafe_overrides = ConfigOverrides {
            model: Some("gpt-5.2-nexal".to_string()),
            ..Default::default()
        };
        let persisted_metadata =
            test_thread_metadata(Some("gpt-5.1-nexal-max"), Some(ReasoningEffort::High))?;
        ...
        assert_eq!(typesafe_overrides.model, Some("gpt-5.2-nexal".to_string()));
        assert_eq!(
            request_overrides,
            Some(HashMap::from([(
                "model_reasoning_effort".to_string(),
    ...
    fn merge_persisted_resume_metadata_skips_persisted_values_when_model_overridden() -> Result<()>
    {
        let mut request_overrides = Some(HashMap::from([(
            "model".to_string(),
            serde_json::Value::String("gpt-5.2-nexal".to_string()),
        )]));
        let mut typesafe_overrides = ConfigOverrides::default();
        let persisted_metadata =
            test_thread_metadata(Some("gpt-5.1-nexal-max"), Some(ReasoningEffort::High))?;
    ...
    async fn removing_thread_state_clears_listener_and_active_turn_history() -> Result<()> {
            ...
            .expect("connection should be live");
        {
            ...
            state.track_current_turn_event(&EventMsg::TurnStarted(
                nexal_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
