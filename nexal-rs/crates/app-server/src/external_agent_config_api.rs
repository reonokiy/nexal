...
use nexal_app_server_protocol::ExternalAgentConfigDetectResponse;
use nexal_app_server_protocol::ExternalAgentConfigImportParams;
use nexal_app_server_protocol::ExternalAgentConfigImportResponse;
use nexal_app_server_protocol::ExternalAgentConfigMigrationItem;
use nexal_app_server_protocol::ExternalAgentConfigMigrationItemType;
use nexal_app_server_protocol::JSONRPCErrorError;
use nexal_core::external_agent_config::ExternalAgentConfigDetectOptions;
use nexal_core::external_agent_config::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use nexal_core::external_agent_config::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use nexal_core::external_agent_config::ExternalAgentConfigService;
use std::io;
...
impl ExternalAgentConfigApi {
    pub(crate) fn new(nexal_home: PathBuf) -> Self {
        Self {
            migration_service: ExternalAgentConfigService::new(nexal_home),
        }
    }
