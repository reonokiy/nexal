...
use nexal_app_server_protocol::Result;
...
mod tests {
    ...
    use nexal_app_server_protocol::ModelRerouteReason;
    use nexal_app_server_protocol::ModelReroutedNotification;
    use nexal_app_server_protocol::RateLimitSnapshot;
    use nexal_app_server_protocol::RateLimitWindow;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-nexal".to_string(),
