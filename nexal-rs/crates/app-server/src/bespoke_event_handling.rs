use crate::nexal_message_processor::ApiVersion;
use crate::nexal_message_processor::read_rollout_items_from_rollout;
use crate::nexal_message_processor::read_summary_from_rollout;
use crate::nexal_message_processor::summary_to_thread;
...
use nexal_app_server_protocol::AccountRateLimitsUpdatedNotification;
use nexal_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use nexal_app_server_protocol::AgentMessageDeltaNotification;
use nexal_app_server_protocol::ApplyPatchApprovalParams;
use nexal_app_server_protocol::ApplyPatchApprovalResponse;
use nexal_app_server_protocol::NexalErrorInfo as V2NexalErrorInfo;
use nexal_app_server_protocol::CollabAgentState as V2CollabAgentStatus;
use nexal_app_server_protocol::CollabAgentTool;
use nexal_app_server_protocol::CollabAgentToolCallStatus as V2CollabToolCallStatus;
use nexal_app_server_protocol::CommandAction as V2ParsedCommand;
use nexal_app_server_protocol::CommandExecutionApprovalDecision;
use nexal_app_server_protocol::CommandExecutionOutputDeltaNotification;
use nexal_app_server_protocol::CommandExecutionRequestApprovalParams;
use nexal_app_server_protocol::CommandExecutionRequestApprovalResponse;
use nexal_app_server_protocol::CommandExecutionRequestApprovalSkillMetadata;
use nexal_app_server_protocol::CommandExecutionSource;
use nexal_app_server_protocol::CommandExecutionStatus;
use nexal_app_server_protocol::ContextCompactedNotification;
use nexal_app_server_protocol::DeprecationNoticeNotification;
use nexal_app_server_protocol::DynamicToolCallOutputContentItem;
use nexal_app_server_protocol::DynamicToolCallParams;
use nexal_app_server_protocol::DynamicToolCallStatus;
use nexal_app_server_protocol::ErrorNotification;
use nexal_app_server_protocol::ExecCommandApprovalParams;
use nexal_app_server_protocol::ExecCommandApprovalResponse;
use nexal_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use nexal_app_server_protocol::FileChangeApprovalDecision;
use nexal_app_server_protocol::FileChangeOutputDeltaNotification;
use nexal_app_server_protocol::FileChangeRequestApprovalParams;
use nexal_app_server_protocol::FileChangeRequestApprovalResponse;
use nexal_app_server_protocol::FileUpdateChange;
use nexal_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use nexal_app_server_protocol::GuardianApprovalReview;
use nexal_app_server_protocol::GuardianApprovalReviewStatus;
use nexal_app_server_protocol::HookCompletedNotification;
use nexal_app_server_protocol::HookStartedNotification;
use nexal_app_server_protocol::InterruptConversationResponse;
...
use nexal_app_server_protocol::McpServerElicitationAction;
use nexal_app_server_protocol::McpServerElicitationRequestParams;
use nexal_app_server_protocol::McpServerElicitationRequestResponse;
use nexal_app_server_protocol::McpServerStartupState;
use nexal_app_server_protocol::McpServerStatusUpdatedNotification;
use nexal_app_server_protocol::McpToolCallError;
use nexal_app_server_protocol::McpToolCallResult;
use nexal_app_server_protocol::McpToolCallStatus;
use nexal_app_server_protocol::ModelReroutedNotification;
use nexal_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use nexal_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use nexal_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use nexal_app_server_protocol::PatchApplyStatus;
use nexal_app_server_protocol::PermissionsRequestApprovalParams;
use nexal_app_server_protocol::PermissionsRequestApprovalResponse;
use nexal_app_server_protocol::PlanDeltaNotification;
use nexal_app_server_protocol::RawResponseItemCompletedNotification;
use nexal_app_server_protocol::ReasoningSummaryPartAddedNotification;
use nexal_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use nexal_app_server_protocol::ReasoningTextDeltaNotification;
...
use nexal_app_server_protocol::SkillsChangedNotification;
use nexal_app_server_protocol::TerminalInteractionNotification;
use nexal_app_server_protocol::ThreadItem;
use nexal_app_server_protocol::ThreadNameUpdatedNotification;
use nexal_app_server_protocol::ThreadRealtimeClosedNotification;
use nexal_app_server_protocol::ThreadRealtimeErrorNotification;
use nexal_app_server_protocol::ThreadRealtimeItemAddedNotification;
use nexal_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use nexal_app_server_protocol::ThreadRealtimeStartedNotification;
use nexal_app_server_protocol::ThreadRealtimeTranscriptUpdatedNotification;
use nexal_app_server_protocol::ThreadRollbackResponse;
use nexal_app_server_protocol::ThreadTokenUsage;
use nexal_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use nexal_app_server_protocol::ToolRequestUserInputOption;
use nexal_app_server_protocol::ToolRequestUserInputParams;
use nexal_app_server_protocol::ToolRequestUserInputQuestion;
use nexal_app_server_protocol::ToolRequestUserInputResponse;
use nexal_app_server_protocol::Turn;
use nexal_app_server_protocol::TurnCompletedNotification;
use nexal_app_server_protocol::TurnDiffUpdatedNotification;
use nexal_app_server_protocol::TurnError;
use nexal_app_server_protocol::TurnInterruptResponse;
use nexal_app_server_protocol::TurnPlanStep;
use nexal_app_server_protocol::TurnPlanUpdatedNotification;
...
use nexal_app_server_protocol::convert_patch_changes;
use nexal_core::NexalThread;
use nexal_core::ThreadManager;
use nexal_core::find_thread_name_by_id;
use nexal_core::review_format::format_review_findings_block;
use nexal_core::review_prompts;
use nexal_protocol::ThreadId;
use nexal_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
use nexal_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use nexal_protocol::items::parse_hook_prompt_message;
...
use nexal_protocol::protocol::ReviewOutputEvent;
use nexal_protocol::protocol::TokenCountEvent;
use nexal_protocol::protocol::TurnDiffEvent;
use nexal_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use nexal_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use nexal_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use nexal_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use nexal_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use nexal_sandboxing::policy_transforms::intersect_permission_profiles;
use nexal_shell_command::parse_command::shlex_join;
...
fn guardian_auto_approval_review_notification(
    ...
    let review = GuardianApprovalReview {
        status: match assessment.status {
            nexal_protocol::protocol::GuardianAssessmentStatus::InProgress => {
                GuardianApprovalReviewStatus::InProgress
            }
            nexal_protocol::protocol::GuardianAssessmentStatus::Approved => {
                GuardianApprovalReviewStatus::Approved
            }
            nexal_protocol::protocol::GuardianAssessmentStatus::Denied => {
                GuardianApprovalReviewStatus::Denied
            }
            nexal_protocol::protocol::GuardianAssessmentStatus::Aborted => {
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            if let ApiVersion::V2 = api_version {
                let (status, error) = match update.status {
                    nexal_protocol::protocol::McpStartupStatus::Starting => {
                        (McpServerStartupState::Starting, None)
                    }
                    nexal_protocol::protocol::McpStartupStatus::Ready => {
                        (McpServerStartupState::Ready, None)
                    }
                    nexal_protocol::protocol::McpStartupStatus::Failed { error } => {
                        (McpServerStartupState::Failed, Some(error))
                    }
                    nexal_protocol::protocol::McpStartupStatus::Cancelled => {
                    ...
                    Err(err) => {
                        ...
                        if let Err(err) = conversation
                            .submit(Op::ResolveElicitation {
                                ...
                                request_id: request.id,
                                decision: nexal_protocol::approvals::ElicitationAction::Cancel,
                                content: None,
                                meta: None,
                            })
                            .await
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                nexal_protocol::protocol::AgentStatus::Errored(_)
                | nexal_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        ...
        EventMsg::CollabWaitingEnd(end_event) => {
            let status = if end_event.statuses.values().any(|status| {
                matches!(
                    status,
                    nexal_protocol::protocol::AgentStatus::Errored(_)
                        | nexal_protocol::protocol::AgentStatus::NotFound
                )
            }) {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let nexal_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
        ...
        EventMsg::Error(ev) => {
            ...
            let nexal_error_info = ev.nexal_error_info.clone();
            ...
            if matches!(
                nexal_error_info,
                Some(CoreNexalErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                nexal_error_info: ev.nexal_error_info.map(V2NexalErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: nexal_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
async fn maybe_emit_hook_prompt_item_completed(
    ...
    let nexal_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(nexal_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: nexal_app_server_protocol::PermissionGrantScope::Turn,
            }
        });
...
fn collab_resume_begin_item(
    begin_event: nexal_protocol::protocol::CollabResumeBeginEvent,
) -> ThreadItem {
...
fn collab_resume_end_item(end_event: nexal_protocol::protocol::CollabResumeEndEvent) -> ThreadItem {
    let status = match &end_event.status {
        nexal_protocol::protocol::AgentStatus::Errored(_)
        | nexal_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        _ => V2CollabToolCallStatus::Completed,
...
mod tests {
    ...
    use nexal_protocol::items::HookPromptFragment;
    use nexal_protocol::items::build_hook_prompt_message;
    ...
    use nexal_protocol::protocol::McpInvocation;
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                id: "item-1".to_string(),
                turn_id: String::new(),
                status: nexal_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_score: None,
                risk_level: None,
                rationale: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: nexal_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_score: Some(91),
                risk_level: Some(nexal_protocol::protocol::GuardianRiskLevel::High),
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(nexal_app_server_protocol::GuardianRiskLevel::High)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                id: "item-3".to_string(),
                turn_id: "turn-from-assessment".to_string(),
                status: nexal_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_score: None,
                risk_level: None,
                rationale: None,
                action: Some(action.clone()),
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: nexal_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        let expected = ThreadItem::CollabAgentToolCall {
            ...
            agents_states: [(
                receiver_id,
                V2CollabAgentStatus::from(nexal_protocol::protocol::AgentStatus::NotFound),
            )]
            .into_iter()
            .collect(),
        };
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                nexal_error_info: Some(V2NexalErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                nexal_error_info: Some(V2NexalErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            OutgoingMessage::AppServerNotification(
                ...
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("nexal"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                nexal_error_info: Some(V2NexalErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            nexal_app_server_protocol::HookPromptFragment {
