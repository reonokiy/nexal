...
use nexal_config_loader::SkillsConfig;
...
impl SkillsManager {
    pub fn new(nexal_home: PathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(nexal_home, bundled_skills_enabled, Some(Product::Nexal))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&manager.nexal_home);
        } else if let Err(err) = install_system_skills(&manager.nexal_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &nexal_config_loader::ConfigLayerStack,
) -> bool {
