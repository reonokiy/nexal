...
//!
//! For the detailed burst state machine, see `nexal-rs/tui/src/bottom_pane/paste_burst.rs`.
...
use nexal_protocol::custom_prompts::PROMPTS_CMD_PREFIX;
...
use nexal_utils_fuzzy_match::fuzzy_match;
    ...
    fn mention_items(&self) -> Vec<MentionItem> {
            ...
            && let Some(snapshot) = self.connectors_snapshot.as_ref()
        {
            for connector in &snapshot.connectors {
                ...
                let slug = nexal_core::connectors::connector_mention_slug(connector);
...
mod tests {
    ...
    fn footer_hint_row_is_separated_from_composer() {
        ...
        let composer = ChatComposer::new(
            ...
            sender,
            false,
            "Ask Nexal to do anything".to_string(),
            false,
        );
    ...
    fn mention_items_show_plugin_owned_skill_and_app_duplicates() {
        ...
        composer.set_skill_mentions(Some(vec![SkillMetadata {
            ...
            interface: Some(nexal_core::skills::model::SkillInterface {
            ...
            scope: nexal_protocol::protocol::SkillScope::Repo,
        }]));
        composer.set_plugin_mentions(Some(vec![PluginCapabilitySummary {
            ...
            app_connector_ids: vec![nexal_core::plugins::AppConnectorId(
...
程序员 与 Unicode 同行";
    ...
    fn file_completion_preserves_large_paste_placeholder_elements() {
        ...
        composer.on_file_search_result(
            ...
            vec![FileMatch {
                ...
                match_type: nexal_file_search::MatchType::File,
    ...
    fn pasting_filepath_attaches_image() {
        ...
        let tmp_path: PathBuf = tmp.path().join("nexal_tui_test_paste_image.png");
