...
#[command(name = "nexal-network-proxy", about = "Nexal network sandbox proxy")]
pub struct Args {}
...
impl NetworkProxyBuilder {
    ...
    pub fn managed_by_nexal(mut self, managed_by_nexal: bool) -> Self {
        self.managed_by_nexal = managed_by_nexal;
        self
    }
...
pub const ALLOW_LOCAL_BINDING_ENV_KEY: &str = "NEXAL_NETWORK_ALLOW_LOCAL_BINDING";
...
mod tests {
    ...
    #[tokio::test]
    async fn non_nexal_managed_proxy_builder_uses_configured_ports() {
