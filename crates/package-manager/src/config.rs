...
pub struct PackageManagerConfig<P> {
    pub(crate) nexal_home: PathBuf,
    pub(crate) package: P,
    cache_root: Option<PathBuf>,
}

impl<P> PackageManagerConfig<P> {
    /// Creates a config rooted at the provided Nexal home directory.
    pub fn new(nexal_home: PathBuf, package: P) -> Self {
        Self {
            nexal_home,
            package,
            cache_root: None,
    ...
    /// Overrides the package cache root instead of deriving it from `nexal_home`.
