//! Shared model metadata types exchanged between Nexal services and clients.
//!
...
/// Metadata describing a Nexal-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Nexal backend `/models` endpoint.
