...
//! `schemars`) so they can be embedded in Nexal's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `nexal-protocol` so other crates can convert
