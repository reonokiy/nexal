...
use nexal_core::default_client::create_client;
...
pub fn get_upgrade_version(config: &Config) -> Option<String> {
    ...
    info.and_then(|info| {
        if is_newer(&info.latest_version, NEXAL_CLI_VERSION).unwrap_or(false) {
...
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/nexal.json";
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/openai/nexal/releases/latest";
...
fn version_filepath(config: &Config) -> PathBuf {
    config.nexal_home.join(VERSION_FILENAME)
}
...
mod tests {
    ...
    fn extract_version_from_brew_api_json() {
        //
        // https://formulae.brew.sh/api/cask/nexal.json
        let cask_json = r#"{
            "token": "nexal",
            "full_token": "nexal",
            "tap": "homebrew/cask",
