...
impl StatusLineItem {
    ...
    pub(crate) fn description(&self) -> &'static str {
        match self {
            ...
            StatusLineItem::NexalVersion => "Nexal application version",
    ...
    fn setup_view_snapshot_uses_runtime_preview_values() {
        ...
        let view = StatusLineSetupView::new(
            ...
            StatusLinePreviewData::from_iter([
                (StatusLineItem::ModelName, "gpt-5-nexal".to_string()),
                (StatusLineItem::CurrentDir, "~/nexal-rs".to_string()),
                (
