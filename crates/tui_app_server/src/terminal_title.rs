...
//! "leave the old title alone" or "clear the title Nexal last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Nexal manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Nexal started managing the title.
