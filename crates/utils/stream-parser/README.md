# nexal-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Nexal did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Nexal on it. Feel free to update the documentation as you
modify the code
...
```rust
use nexal_utils_stream_parser::CitationStreamParser;
use nexal_utils_stream_parser::StreamTextParser;
...
```rust
use nexal_utils_stream_parser::CitationStreamParser;
use nexal_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), nexal_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use nexal_utils_stream_parser::InlineHiddenTagParser;
use nexal_utils_stream_parser::InlineTagSpec;
use nexal_utils_stream_parser::StreamTextParser;
