//! Helpers for truncating tool and exec output using [`TruncationPolicy`](nexal_protocol::protocol::TruncationPolicy).

use nexal_protocol::models::FunctionCallOutputContentItem;
pub use nexal_utils_string::approx_bytes_for_tokens;
pub use nexal_utils_string::approx_token_count;
pub use nexal_utils_string::approx_tokens_from_byte_count;
use nexal_utils_string::truncate_middle_chars;
use nexal_utils_string::truncate_middle_with_token_budget;

pub use nexal_protocol::protocol::TruncationPolicy;
