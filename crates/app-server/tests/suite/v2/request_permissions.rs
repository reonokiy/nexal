...
async fn request_permissions_round_trip() -> Result<()> {
    let nexal_home = tempfile::TempDir::new()?;
    let responses = vec![
    ...
    mcp.send_response(
        ...
        serde_json::to_value(PermissionsRequestApprovalResponse {
            permissions: nexal_app_server_protocol::GrantedPermissionProfile {
                network: None,
                file_system: Some(nexal_app_server_protocol::AdditionalFileSystemPermissions {
                    read: None,
