...
type PendingInterruptQueue = Vec<(
    ConnectionRequestId,
    crate::nexal_message_processor::ApiVersion,
)>;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: nexal_app_server_protocol::Thread,
}
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<NexalThread>>,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<NexalThread>) -> bool {
