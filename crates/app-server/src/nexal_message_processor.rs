...
impl NexalMessageProcessor {
    ...
    async fn plugin_list(&self, request_id: ConnectionRequestId, _params: PluginListParams) {
        // Plugin marketplace listing has been removed.
        self.outgoing
            .send_response(
                request_id,
                PluginListResponse {
    ...
    async fn plugin_read(&self, request_id: ConnectionRequestId, _params: PluginReadParams) {
        // Plugin marketplace read has been removed.
        self.send_invalid_request_error(
            request_id,
            "plugin marketplace read is no longer supported".to_string(),
        )
        .await;
    }
    ...
    async fn plugin_install(&self, request_id: ConnectionRequestId, _params: PluginInstallParams) {
        // Plugin marketplace install has been removed.
        self.send_invalid_request_error(
            request_id,
            "plugin marketplace install is no longer supported".to_string(),
        )
        .await;
    }
    ...
    async fn plugin_uninstall(
        ...
        // Plugin marketplace uninstall has been removed.
        self.send_invalid_request_error(
            request_id,
            "plugin marketplace uninstall is no longer supported".to_string(),
        )
        .await;
    }
