...
//!
//! # Relationship to `nexal-app-server-client`
//!
//! This module provides the low-level runtime handle ([`InProcessClientHandle`]).
//! Higher-level callers (TUI, exec) should go through `nexal-app-server-client`,
...
/// through `nexal-app-server-client`, which adds worker-task buffering,
        ...
        let args = InProcessStartArgs {
            ...
            initialize: InitializeParams {
                client_info: ClientInfo {
                    name: "nexal-in-process-test".to_string(),
                    title: None,
