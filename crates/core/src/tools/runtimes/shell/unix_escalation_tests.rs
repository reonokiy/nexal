...
#[cfg(target_os = "macos")]
use nexal_sandboxing::seatbelt::MACOS_PATH_TO_SEATBELT_EXECUTABLE;
...
async fn prepare_escalated_exec_permissions_preserve_macos_seatbelt_extensions() {
    ...
    let permissions = Permissions {
        ...
        file_system_sandbox_policy: read_only_file_system_sandbox_policy(),
        network_sandbox_policy: nexal_protocol::permissions::NetworkSandboxPolicy::Restricted,
        network: None,
