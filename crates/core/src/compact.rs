...
use crate::nexal::get_last_assistant_message_from_turn;
...
async fn run_compact_task_inner(
    ...
    loop {
        ...
        match attempt_result {
            ...
            Err(NexalErr::Interrupted) => {
                return Err(NexalErr::Interrupted);
            }
            Err(e @ NexalErr::ContextWindowExceeded) => {
                if turn_input_len > 1 {
