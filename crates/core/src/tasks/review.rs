...
use nexal_protocol::protocol::AgentMessageContentDeltaEvent;
...
use crate::nexal_delegate::run_nexal_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        // Start sub-nexal conversation and get the receiver for events.
