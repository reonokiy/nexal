...
use nexal_network_proxy::NetworkProxyConstraintError;
use nexal_network_proxy::NetworkProxyConstraints;
use nexal_network_proxy::NetworkProxyState;
use nexal_network_proxy::build_config_state;
use nexal_network_proxy::normalize_host;
use nexal_network_proxy::validate_policy_against_constraints;
    ...
    stack
        ...
        .filter_map(|layer| {
            let path = match &layer.name {
                ...
                ConfigLayerSource::Project { dot_nexal_folder } => dot_nexal_folder
