...
const NEXAL_ARC_MONITOR_ENDPOINT_OVERRIDE: &str = "NEXAL_ARC_MONITOR_ENDPOINT_OVERRIDE";
const NEXAL_ARC_MONITOR_TOKEN: &str = "NEXAL_ARC_MONITOR_TOKEN";
...
struct ArcMonitorMetadata {
    nexal_thread_id: String,
    nexal_turn_id: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
async fn build_arc_monitor_request(
    ...
    ArcMonitorRequest {
        metadata: ArcMonitorMetadata {
            nexal_thread_id: conversation_id.clone(),
