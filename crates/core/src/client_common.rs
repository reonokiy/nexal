...
pub use nexal_api::common::ResponseEvent;
...
pub(crate) mod tools {
    ...
    use nexal_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
    use nexal_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
    use nexal_protocol::config_types::WebSearchUserLocationType;
    use serde::Deserialize;
    use serde::Serialize;
    use serde_json::Value;
