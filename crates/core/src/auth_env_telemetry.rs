...
pub(crate) struct AuthEnvTelemetry {
    ...
    pub(crate) nexal_api_key_env_present: bool,
    pub(crate) nexal_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub(crate) fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            nexal_api_key_env_present: self.nexal_api_key_env_present,
            nexal_api_key_env_enabled: self.nexal_api_key_env_enabled,
...
pub(crate) fn collect_auth_env_telemetry(
    ...
    nexal_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        nexal_api_key_env_present: env_var_present(NEXAL_API_KEY_ENV_VAR),
        nexal_api_key_env_enabled,
