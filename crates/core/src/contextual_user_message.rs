use nexal_instructions::AGENTS_MD_FRAGMENT;
use nexal_instructions::ContextualUserFragmentDefinition;
use nexal_instructions::SKILL_FRAGMENT;
use nexal_protocol::items::HookPromptItem;
use nexal_protocol::items::parse_hook_prompt_fragment;
use nexal_protocol::models::ContentItem;
use nexal_protocol::protocol::ENVIRONMENT_CONTEXT_CLOSE_TAG;
