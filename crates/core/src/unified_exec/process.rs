...
use nexal_exec_server::ExecProcess;
use nexal_exec_server::ReadResponse as ExecReadResponse;
use nexal_exec_server::StartedExecProcess;
use nexal_exec_server::WriteStatus;
use nexal_protocol::protocol::TruncationPolicy;
...
use nexal_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = nexal_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
