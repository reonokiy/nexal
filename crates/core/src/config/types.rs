...
pub use nexal_protocol::config_types::AltScreenMode;
pub use nexal_protocol::config_types::ApprovalsReviewer;
pub use nexal_protocol::config_types::ModeKind;
pub use nexal_protocol::config_types::Personality;
pub use nexal_protocol::config_types::ServiceTier;
pub use nexal_protocol::config_types::WebSearchMode;
...
pub struct McpServerConfig {
    ...
    /// When `false`, Nexal skips initializing this MCP server.
    #[serde(default = "default_enabled")]
    pub enabled: bool,

    /// When `true`, `nexal exec` exits with an error if this MCP server fails to initialize.
...
pub struct AnalyticsConfigToml {
    /// When `false`, disables analytics across Nexal product surfaces in this profile.
    pub enabled: Option<bool>,
}
...
pub struct FeedbackConfigToml {
    /// When `false`, disables the feedback flow across Nexal product surfaces.
    pub enabled: Option<bool>,
}
...
pub struct AppConfig {
    /// When `false`, Nexal does not surface this app.
    #[serde(default = "default_enabled")]
    pub enabled: bool,
...
pub struct Tui {
    ...
    /// Use `/theme` in the TUI or see `$NEXAL_HOME/themes` for custom themes.
    #[serde(default)]
...
/// (primarily the Nexal IDE extension). NOTE: these are different from
...
pub struct Notice {
    ...
    /// Tracks whether the user has seen the gpt-5.1-nexal-max migration prompt
    #[serde(rename = "hide_gpt-5.1-nexal-max_migration_prompt")]
    pub hide_gpt_5_1_nexal_max_migration_prompt: Option<bool>,
...
pub use nexal_config_loader::BundledSkillsConfig;
pub use nexal_config_loader::SkillConfig;
pub use nexal_config_loader::SkillsConfig;
...
impl From<SandboxWorkspaceWrite> for nexal_app_server_protocol::SandboxSettings {
