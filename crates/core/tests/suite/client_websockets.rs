...
// Test responses_websocket_reuses_connection_with_per_turn_trace_payloads removed:
// it depended on the now-removed OTEL trace propagation pipeline.


// Test responses_websocket_preconnect_does_not_replace_turn_trace_payload removed:
// it depended on the now-removed OTEL trace propagation pipeline.
