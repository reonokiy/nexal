...
use bytes::Bytes;
use nexal_api::AuthProvider;
use nexal_api::Provider;
use nexal_api::ResponsesApiRequest;
use nexal_api::ResponsesClient;
use nexal_api::ResponsesOptions;
use nexal_api::requests::responses::Compression;
use nexal_client::HttpTransport;
use nexal_client::Request;
use nexal_client::Response;
use nexal_client::StreamResponse;
...
fn provider(name: &str) -> Provider {
    Provider {
        ...
        query_params: None,
        headers: HeaderMap::new(),
        retry: nexal_api::provider::RetryConfig {
            max_attempts: 1,
