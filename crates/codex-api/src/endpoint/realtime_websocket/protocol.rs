...
pub use nexal_protocol::protocol::RealtimeAudioFrame;
pub use nexal_protocol::protocol::RealtimeEvent;
pub use nexal_protocol::protocol::RealtimeHandoffRequested;
pub use nexal_protocol::protocol::RealtimeTranscriptDelta;
pub use nexal_protocol::protocol::RealtimeTranscriptEntry;
use serde::Serialize;
