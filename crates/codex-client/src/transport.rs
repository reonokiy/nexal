use crate::default_client::NexalHttpClient;
use crate::default_client::NexalRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: NexalHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<NexalRequestBuilder, TransportError> {
        let Request {
            method,
            url,
            mut headers,
